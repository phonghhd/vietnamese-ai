...
class SecureEdgeNode:
    ...
    def __init__(self, node_id: str, private_key: str, model_path: str = "models/llama-3-8b-instruct.Q4_K_M.gguf", auto_start: bool = True):
        self.node_id = node_id
        self.private_key = private_key.encode('utf-8')

        # Bọc Llama Engine vào bên trong "Enclave"
        self.engine = NodeLlamaEngine(model_path=model_path, context_size=2048, auto_start=auto_start)
    ...
    @staticmethod
    def verify_proof(node_id: str, public_key: str, cau_hoi: str, cau_tra_loi: str, proof: str, model_hash: str) -> bool:
        """
        ...
        expected_signature = hmac.new(public_key.encode('utf-8'), payload, hashlib.sha256).hexdigest()
