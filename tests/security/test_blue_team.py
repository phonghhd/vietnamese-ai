...
def test_auto_patching():
    ...
    assert an_toan_1 == True # AST checker hiện tại (chưa vá) chưa cấm importlib
    ...
    blue_team.bo_nho.them_tin_nhan("assistant", "Suy nghĩ: Cần chặn importlib và getattr.\nHành động: cap_nhat_sandbox\nTham số: {\"module_cam_moi\": [\"importlib\"], \"ham_cam_moi\": [\"getattr\"]}\n")
    ...
    assert an_toan_2 == False # Sandbox đã chặn importlib!
